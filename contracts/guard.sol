...
contract guard {
    ...
    function updateSalt(address[] calldata users, uint256[] calldata salts) public {
    ...
    function banUser(address[] calldata addrs) public {
    ...
    function recoverUser(address[] calldata addrs) public {
        for (uint i = 0; i < addrs.length; i++) {
    ...
    function getSaltStatus(address[] calldata addrs) public view returns (uint256[] memory, bool[] memory) {
